...
case TRANSACTION_say_hello_to:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
int _result = this.say_hello_to(_arg0);
reply.writeNoException();
...
@Override public int say_hello_to(java.lang.String name) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
mRemote.transact(Stub.TRANSACTION_say_hello_to, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_say_hello_to = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
}
public void hello() throws android.os.RemoteException;
public int say_hello_to(java.lang.String name) throws android.os.RemoteException;
}
